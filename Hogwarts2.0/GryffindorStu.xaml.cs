...
namespace Hogwarts2._0
{
    ...
    /// </summary>
    public sealed partial class GryffindorStu : Page
    {
        ...
        private void NavigationView_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
        {
            ...
            {
                case "Home":
                    ContentFrame.Navigate(typeof(GStuHome),UserHuid);
                    break;
                case "AccountPage":
                    ContentFrame.Navigate(typeof(GStuAccount),UserHuid);
                    break;
                case "MyGradesPage":
                    ContentFrame.Navigate(typeof(GStuCourses),UserHuid);
                    break;
                case "AccountSettings":
                    ContentFrame.Navigate(typeof(GStuAccountSettings), UserHuid);
                    break;
                case "Logout":
