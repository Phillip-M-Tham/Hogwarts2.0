...
namespace Hogwarts2._0
{
    ...
    /// </summary>
    public sealed partial class RStuHome : Page
    {
        ...
        private async void setuphomepage()
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(ConnectionString))
            {
                ...
                if (sqlConn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    {
                        cmd.CommandText = $"SELECT ProfHUID FROM HouseHead WHERE HouseName = 'Ravenclaw';";
                    ...
                    using (SqlCommand cmd = sqlConn.CreateCommand())
                    {
                        cmd.CommandText = $"SELECT CurrentSemesterID,RavenclawPoints FROM HousePoints;";
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
