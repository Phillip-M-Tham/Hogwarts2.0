...
namespace Hogwarts2._0
{
    ...
    /// </summary>
    public sealed partial class HufflepuffStu : Page
    {
        ...
        private void NavigationView_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
        {
            ...
            {
                case "Home":
                    ContentFrame.Navigate(typeof(HStuHome), UserHuid);
                    break;
                case "AccountPage":
                    ContentFrame.Navigate(typeof(HStuAccount), UserHuid);
                    break;
                case "MyGradesPage":
                    ContentFrame.Navigate(typeof(HStuCourses), UserHuid);
                    break;
                case "AccountSettings":
                    ContentFrame.Navigate(typeof(HStuAccountSettings), UserHuid);
                    break;
                case "Logout":
